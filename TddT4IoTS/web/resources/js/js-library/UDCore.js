...
var ComponentStyle = {component_color: "#000000"};
...
var NodeStyle = {shape_color: "rgb( 0, 0, 0 )", control: ""};
var Node = function (a) {
    a = a || {};
    this._id = 0;
    this._type = "untyped";
...
var RelationStyle = {shape_color: "#000000"};
...
Relation.prototype.setComponentName = function (a) {
    if (!this._name) {
        this._name = new TextBox({id: "name", text: a});
...
Relation.prototype.setStereotype = function (a) {
    this._stereotype = new Text({id: "stereotype", text: a, centered: true});
    this._addComponent(this._stereotype)
};
Relation.prototype.addComponentStereotype = function (a) {
    if (!this._stereotype) {
        this._stereotype = new StereotypeFields({id: "stereotype", width: 100, text: a});
        this._addComponent(this._stereotype)
    }
};
Relation.prototype.setComponentRoleA = function (a) {
    if (!this._roleA) {
        this._roleA = new RoleItem({id: "roleA", text: a, margin: 4});
...
Relation.prototype.setComponentRoleB = function (a) {
    if (!this._roleB) {
        this._roleB = new RoleItem({id: "roleB", text: a, margin: 4});
...
Relation.prototype.setComponentMultiplicityA = function (a) {
    if (!this._multiA) {
        this._multiA = new TextBox({id: "multiplicityA", text: a, margin: 4});
...
Relation.prototype.setComponentMultiplicityB = function (a) {
    if (!this._multiB) {
        this._multiB = new TextBox({id: "multiplicityB", text: a, margin: 4});
...
Diagram.prototype.setXML = function (b) {
    var e = [];
    console.log("QUE VERGA",this._alone);
    if (this._alone) {
        var a = b.getElementsByTagName(this.getType())[0];
        console.log(this.getType());
        console.log("QUE ES ESTA a", a);
        if (!a) {
            return false
        }
    } else {
...
Diagram.prototype.setXMLString = function (b) {
    ...
    b = b.replace(/\n/gi, "");
    console.log("QUE TIRO DESDE LA LIBRERIA",b)
...
RegionLine.prototype.select = function (b, g) {
    ...
    if (!this.selected && this.isOver(b, g)) {
        ...
        this._dragComponent = function (h) {
            ...
            f.getParent()._diagram._div.style.cursor = "move";
        ...
        if (this._selected) {
            ...
            for (b = 0; b < a.length - 1; b++) {
                if (b == e) {
                    ...
                    var n = new Dialog({text: "Do you want to delete the region?", cancelable: true});
