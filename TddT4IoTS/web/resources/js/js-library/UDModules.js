...
Flow.prototype.updateName = function () {
    ...
    if (this._elemA.getType() != "UMLDecision_MergeNode" && this._name instanceof GuardItem) {
        ...
        this._name = new TextArea({id: "name_node", text: a});
        this._addComponent(this._name)
    } else {
        if (this._elemA.getType() == "UMLDecision_MergeNode" && !(this._name instanceof GuardItem)) {
            var a = "[" + this._name._text.join("\n") + "]";
            this._delComponent(this._name);
            this._name = new GuardItem({id: "description", text: a});
            this._addComponent(this._name)
        }
    }
};
        ...
        if (this._selected) {
            ...
            for (b = 0; b < a.length - 1; b++) {
                if (b == g) {
                    ...
                    var d = this;
                    var p = new Dialog({text: "Do you want to delete the region?", cancelable: true});
...
UMLStereotypedElement.prototype.drawStereotype = function (a) {
    ...
    if (!d && a.getPath()) {
        c.addFigure(new FromImageFigure({route: a.getPath()}));
...
var setStereotypeProperties = function (a, b) {
    a._stereotypeProperties = new UMLStereotypedElement({stereotypes: b, parent: a})
};
...
StereotypeTagList.prototype.newItem = function () {
    return new StereotypeTag({text: "\xABstereotype\xBB", orientation: this._orientation || 0, centered: true})
};
        ...
        if (this._selected) {
            ...
            for (c = 0; c < a.length - 1; c++) {
                if (c == h) {
                    ...
                    var e = this;
                    var q = new Dialog({text: "Do you want to delete the region?", cancelable: true});
...
var UMLAcceptEventAction = function (b) {
    ...
    a.setWidth(100);
    a.setHeight(55);
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", centered: true, margin: 3}));
    a.addFigure(new AcceptEventActionFigure({color: "#ffffbb"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
...
var UMLTimeEvent = function (b) {
    ...
    a.setWidth(40);
    a.setHeight(50);
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Bottom}));
    a.addComponent(new TextArea({id: "name", position: Component.Bottom, margin: 3}));
    a.addFigure(new TimeEventFigure({color: "#ffffbb"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLAction = function (b) {
    ...
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", centered: true, margin: 3}));
    a.addFigure(new RoundedRectangleFigure({color: "#ffffbb"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLDataStore = function (b) {
    ...
    a.setMoveable();
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new Text({centered: true, text: "\xABdatastore\xBB", margin: 1}));
    a.addComponent(new DataStoreItem({id: "name", centered: true, margin: 3}));
    a.addFigure(new RectangleFigure({color: "#ffffbb"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLExpansionNode = function (b) {
    ...
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Bottom}));
    a.addComponent(new TextArea({id: "name", position: Component.Bottom, margin: 3}));
    a.addFigure(new ExpansionNodeFigure({color: "#ffffbb"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLObject = function (b) {
    ...
    a.setMoveable();
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new ObjectItem({id: "name", centered: true, margin: 3}));
    a.addFigure(new RectangleFigure({color: "#ffffbb"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
...
var UMLActivityFinal = function (b) {
    ...
    a.setWidth(16);
    a.setHeight(16);
    a.addFigure(new HalfFilledEllipseFigure({color: "#ffffff", changeFigureColor: false}));
    return a
};
var UMLInitialNode = function (b) {
    ...
    a.setWidth(16);
    a.setHeight(16);
    a.addFigure(new EllipseFigure({color: "#000000", changeFigureColor: false}));
    return a
};
var UMLFlowFinal = function (b) {
    ...
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Bottom}));
    a.addComponent(new TextArea({id: "name", position: Component.Bottom, margin: 3}));
    a.addFigure(new CrossEllipseFigure({color: "#ffffff", changeFigureColor: false}));
    a.setMenu([[function () {
        getStereotypeProperties(a).showTagValuesDialog();
        a.removeContextualMenu()
    }, "Tag value"], [function () {
...
var UMLDecision_MergeNode = function (b) {
    ...
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Bottom}));
    a.addComponent(new TextArea({id: "name", position: Component.Bottom, margin: 3}));
    a.addFigure(new RhombusFigure({color: "#bdd8e5"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLFork_JoinNode = function (b) {
    ...
    a.setMinHeight(5);
    a.setMoveable();
    a.addFigure(new RectangleFigure({color: "#000000", changeFigureColor: false}));
    return a
};
var UMLSendSignalAction = function (b) {
    ...
    a.setContainer();
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextBox({id: "name", centered: true, margin: 3}));
    a.addFigure(new SendSignalActionFigure({color: "#ffffbb"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLConnectorActivity = function (b) {
    ...
    a.setMoveable();
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Bottom}));
    a.addComponent(new ConnectorItem({id: "name", centered: true, margin: 3, width: 20}));
    a.addFigure(new EllipseFigure({color: "#ffffbb"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLHorizontalSwimlane = function (b) {
    ...
    a.setMoveable();
    a.setContainer();
    a.addComponent(new SwimlaneItem({id: "addRegion", text: "...", margin: 1, position: Component.BottomRight}));
    a.addFigure(new SwimlaneFigure());
    if (b.setElementXml) {
    } else {
        a.addRegion(new Swimlane({parent: a, y: a.getY(), x: a.getX()}));
        a.addRegion(new Swimlane({parent: a, y: a.getY(), x: a.getX()}))
    }
    return a
};
...
var UMLHorizontalHierarchicalSwimlane = function (b) {
    ...
    a.setMoveable();
    a.setContainer();
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true, orientation: 1}));
    a.addComponent(new TextBox({id: "name", centered: true, margin: 3, orientation: 1}));
    a.addComponent(new Separator({id: "separator", centered: true, orientation: 1, width: 2.5}));
    a.addComponent(new SwimlaneItem({id: "addRegion", text: "...", margin: 1, position: Component.BottomRight}));
    a.addFigure(new SwimlaneFigure());
    if (b.setElementXml) {
    } else {
...
var UMLVerticalHierarchicalSwimlane = function (b) {
    ...
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextBox({id: "name", centered: true, margin: 3}));
    a.addComponent(new Separator({id: "separator", centered: true, height: 2.5}));
    a.addComponent(new SwimlaneItem({id: "addRegion", text: "...", margin: 1, position: Component.BottomRight}));
    a.addFigure(new VerticalSwimlaneFigure());
    if (b.setElementXml) {
    } else {
...
GeneralizationSet.prototype.addElement = function (b) {
    ...
    relation = new SetLine({a: b, b: this});
...
var SetLine = function (a) {
    ...
    if (this._elemB) {
        this.setMenu([[function () {
            f._elemB.showStyleDialog({that: f._elemB});
...
NAssociation.prototype.setElements = function (b, a) {
    if (!(b instanceof Array)) {
        if (b instanceof Node && a instanceof Node) {
            relation = new AssociationN({a: b, b: this});
            relation._calculateLineEnds();
            relation.updateParent();
            relation = new AssociationN({a: a, b: this});
            relation._calculateLineEnds();
            relation.updateParent();
            this.notifyChange();
            return true
...
var UMLPackage = function (b) {
    ...
    a.setWidth(100);
    a.setHeight(50);
    a.addFigure(new PackageFigure({color: "#c0e1c2"}));
    a.addComponent(new Space({height: 16}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", text: "Package name", centered: true, margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLPackageContainer = function (b) {
    ...
    a.setMoveable();
    a.setContainer();
    a.addFigure(new RectangleFigure({color: "#c0e1c2"}));
    a.addComponent(new StereotypeTagList({id: "stereotypes"}));
    a.addComponent(new Tab({id: "name", margin: 5, text: "Package name"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLClass = function (b) {
    ...
    a.setMoveable();
    a.addFigure(new RectangleFigure({color: "#ffffbb"}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true, margin: 3}));
    a.addComponent(new TextArea({id: "name", text: "ClassName", centered: true, margin: 3}));
    a.addComponent(new AttributeFields({id: "attributes", margin: 3}));
    a.addComponent(new OperationFields({id: "operations", margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
        ...
        a.removeContextualMenu()
    }, "Change abstract property"], [function () {
        getStereotypeProperties(a).showTagValuesDialog();
        a.removeContextualMenu()
    }, "Tag value"], [function () {
        getStereotypeProperties(a).showApplyStereotypesDialog();
...
var UMLComponent = function (b) {
    ...
    a.setWidth(150);
    a.addFigure(new RectangleFigure({color: "#ffffbb"}));
    a.addComponent(new ComponentSymbol({position: Component.TopRight, margin: 3}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new Text({text: "\xABcomponent\xBB", centered: true}));
    a.addComponent(new TextArea({id: "name", text: "Component Name", centered: true, margin: 3}));
    a.addComponent(new AttributeFields({id: "attributes", visibleSubComponents: false, margin: 3}));
    a.addComponent(new OperationFields({id: "operations", visibleSubComponents: false, margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLInterfaceExtended = function (b) {
    ...
    a.addFigure(new RectangleFigure({color: "#c0e1c2"}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new CircleSymbol({position: Component.TopRight, margin: 3}));
    a.addComponent(new TextArea({id: "name", text: "Interface Name", centered: true, margin: 3}));
    a.addComponent(new AttributeFields({id: "attributes", visibleSubComponents: false, margin: 3}));
    a.addComponent(new OperationFields({id: "methods", visibleSubComponents: false, margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLDataType = function (b) {
    ...
    a.setMoveable();
    a.addFigure(new RectangleFigure({color: "#ffffbb"}));
    a.addComponent(new Text({text: "\xABdatatype\xBB", centered: true}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", text: "DataTypeName", centered: true, margin: 3}));
    a.addComponent(new AttributeFields({id: "attributes", margin: 3}));
    a.addComponent(new OperationFields({id: "operations", margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
...
var UMLNAssociation = function (b) {
    ...
    a.addFigure(new RhombusFigure({color: "#ffffbb"}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", text: " ", centered: true, margin: 3}));
    return a
};
...
var UMLInstance = function (b) {
    ...
    a.setMoveable();
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new InstanceItem({id: "name", centered: true, margin: 3}));
    a.addComponent(new AttributeFields({id: "attributes", margin: 3}));
    a.addFigure(new RectangleFigure({color: "#ffffbb"}));
...
var UMLLink = function (c) {
    ...
    var a = new InstanceItem({id: "name", centered: true, margin: 3});
    b._addComponent(a);
    b._name = a;
    b.setComponentMultiplicityA();
    b.setComponentMultiplicityB();
    b.setMenu([[function () {
        b.showStyleDialog({that: b});
        b.removeContextualMenu()
    }, "Style"], [function () {
        b.showDirectionDialog({that: b});
        b.removeContextualMenu()
    }, "Navegability"]]);
...
var UMLPackageContainer = function (b) {
    ...
    a.setMoveable();
    a.setContainer();
    a.addFigure(new RectangleFigure({color: "#bdd8e5"}));
    a.addComponent(new StereotypeTagList({id: "stereotypes"}));
    a.addComponent(new Tab({id: "name", margin: 5, text: "Package name"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
...
var UMLArtifact = function (b) {
    ...
    a.setMoveable();
    a.addFigure(new RectangleFigure({color: "#ffffbb"}));
    a.addComponent(new Text({text: "\xABartifact\xBB", centered: true, margin: 3}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", text: "Artifact Name", centered: true, margin: 3}));
    a.getNameAsComponent().setUnderlineText(true);
    a.addComponent(new PropertyFields({id: "properties", visibleSubComponents: false, margin: 3}));
    a.addComponent(new ArtifactSymbol({position: Component.TopRight, margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLInterface = function (b) {
    ...
    a.setWidth(16);
    a.setHeight(16);
    a.addFigure(new EllipseFigure({color: "#67ac88"}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Bottom}));
    a.addComponent(new TextArea({id: "name", position: Component.Bottom, margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
...
var UMLNode = function (b) {
    ...
    a.setMoveable();
    a.setContainer();
    a.addFigure(new CubeFigure({color: "#c0e1c2"}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", text: "Node name", centered: true, margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLNodeTextNotation = function (b) {
    ...
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", text: "Node name", centered: true, margin: 3}));
    a.addComponent(new ArtifactFields({id: "artifacts", margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLDeploymentSpecification = function (b) {
    ...
    a.setMoveable();
    a.addFigure(new RectangleFigure({color: "#ffffbb"}));
    a.addComponent(new Text({text: "\xABdeployment spec\xBB", centered: true, margin: 3}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", text: "Name", centered: true, margin: 3}));
    a.addComponent(new AttributeFields({id: "attributes", visibleSubComponents: false, margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
...
var UMLNote = function (b) {
    ...
    a.setWidth(100);
    a.setHeight(50);
    a.addFigure(new NoteFigure({color: "#ffffbb"}));
    a.addComponent(new StereotypeFields({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "description", text: "Note", centered: true, margin: 5}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"]]);
...
var UMLMetaclass = function (b) {
    ...
    a.setHeight(30);
    a.addFigure(new RectangleFigure({color: "#c0e1c2"}));
    a.addComponent(new StereotypeItem({id: "stereotype", text: "\xABmetaclass\xBB", selected: true, centered: true}));
    a.addComponent(new MetaclassItem({id: "name", text: "MetaClass name", centered: true, margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"]]);
...
var UMLStereotype = function (b) {
    ...
    a.setMoveable();
    a.addFigure(new RectangleFigure({color: "#c0e1c2"}));
    a.addComponent(new StereotypeItem({id: "stereotype", text: "\xABstereotype\xBB", selected: true, centered: true}));
    a.addComponent(new StereotypeNameItem({id: "name", text: "stereotype name", centered: true}));
    a.addComponent(new Separator({id: "separator", centered: true}));
    a.addComponent(new TagValueFields({id: "attributes", margin: 3}));
    a.addComponent(new SrcItem({id: "src", text: "path:/", margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"]]);
...
var UMLExtension = function (b) {
    ...
    a.setLine(new SolidLine());
    a.setEnd(new CloseTip({color: "#000000"}));
    return a
};
...
var UMLLifeline = function (b) {
    ...
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextBox({id: "name", centered: true, margin: 3}));
    a.addFigure(new LifelineFigure({color: "#c6dbdc"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLOption = function (b) {
    ...
    a.setHeight(100);
    a.addComponent(new StereotypeTagList({id: "stereotypes"}));
    a.addComponent(new Tab({id: "name", text: "OPT", margin: 4, selected: true}));
    a.addComponent(new GuardItem({id: "guard", text: "[]", margin: 1}));
...
var UMLAlternative = function (b) {
    ...
    a.setHeight(100);
    a.addComponent(new StereotypeTagList({id: "stereotypes"}));
    a.addComponent(new Tab({id: "name", text: "ALT", margin: 4, selected: true}));
    ...
    if (b.setElementXml) {
        ...
        a.addRegion(new RegionAlternative({parent: a, position: Component.BottomLeft}));
        a.addRegion(new RegionAlternative({parent: a, position: Component.BottomLeft}))
    }
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
...
var UMLLoop = function (b) {
    ...
    a.setHeight(100);
    a.addComponent(new StereotypeTagList({id: "stereotypes"}));
    a.addComponent(new LoopItem({id: "name", text: "LOOP", margin: 4}));
    a.addComponent(new GuardItem({id: "guard", text: "[]", margin: 1}));
    a.addFigure(new RectangleFigure());
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
...
var UMLBreak = function (b) {
    ...
    a.setHeight(100);
    a.addComponent(new StereotypeTagList({id: "stereotypes"}));
    a.addComponent(new Tab({id: "name", text: "BREAK", margin: 4, selected: true}));
    a.addFigure(new RectangleFigure());
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
...
var UMLTerminate = function (b) {
    ...
    a.setWidth(20);
    a.setHeight(20);
    a.addFigure(new CrossFigure({color: "#000000", changeFigureColor: false}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Bottom}));
    a.addComponent(new TextArea({id: "name", position: Component.Bottom, margin: 3}));
    a.setMenu([[function () {
        getStereotypeProperties(a).showTagValuesDialog();
...
var UMLEntryPoint = function (b) {
    ...
    a.setWidth(14);
    a.setHeight(14);
    a.addFigure(new EllipseFigure({color: "#ffffff", changeFigureColor: false}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Bottom}));
    a.addComponent(new TextArea({id: "name", position: Component.Bottom, margin: 3}));
    a.setMenu([[function () {
        getStereotypeProperties(a).showTagValuesDialog();
...
var UMLSimpleState = function (b) {
    ...
    a.setMoveable();
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", centered: true, position: Component.Static, margin: 5}));
...
var UMLCompositeState = function (b) {
    ...
    a.setMoveable();
    a.setContainer();
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Xmovement}));
    a.addComponent(new TextBox({id: "name", text: "StateName", margin: 3, position: Component.Xmovement}));
    a.addComponent(new SpecificationItem({
        id: "specification",
        centered: false,
        position: Component.BottomLeft,
    ...
    a.addFigure(new RegionFigure({color: "#ffffbb"}));
    ...
    if (b.setElementXml) {
        ...
        a.addRegion(new Region({parent: a}))
    }
    a.setMenu([[function () {
        for (var c = 0; c < a._components.length; c++) {
            if (a._components[c] instanceof SpecificationItem) {
...
var UMLVerticalRegion = function (b) {
    ...
    a.setContainer();
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Xmovement}));
    a.addComponent(new TextBox({id: "name", text: "RegionName", margin: 3, position: Component.Xmovement}));
    a.addComponent(new SpecificationItem({
        id: "specification",
        centered: false,
        position: Component.BottomLeft,
    ...
    a.addComponent(new RegionStateItem({id: "addRegion", text: "...", margin: 1, position: Component.BottomRight}));
    a.addFigure(new RegionFigure({color: "#ffffbb"}));
    a.setHeightSmallRectangle(a._components[0].getHeight() + a._components[1].getHeight());
    a.setWidthSmallRectangle(a._components[1].getWidth());
    if (b.setElementXml) {
    } else {
        a.addRegion(new RegionState({parent: a}));
        a.addRegion(new RegionState({parent: a}))
    }
    a.setMenu([[function () {
        for (var c = 0; c < a._components.length; c++) {
...
var UMLActor = function (b) {
    ...
    a.addComponent(new StereotypeTagList({id: "stereotypes", position: Component.Bottom}));
    a.addComponent(new TextArea({id: "name", position: Component.Bottom}));
    a.setMenu([[function () {
        getStereotypeProperties(a).showTagValuesDialog();
        a.removeContextualMenu()
    }, "Tag value"], [function () {
...
var UMLUseCaseExtended = function (b) {
    ...
    a.addFigure(new EllipseFigure());
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", centered: true}));
    a.addComponent(new Separator());
    a.addComponent(new Text({text: "extension points", centered: true}));
    a.addComponent(new TextFields({id: "extension", centered: true}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLSystem = function (b) {
    ...
    a.setMoveable();
    a.setContainer();
    a.addFigure(new RectangleFigure({color: "#c6dbdc"}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new Tab({id: "name", margin: 5, text: "System name"}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLSubSystem = function (b) {
    ...
    a.setContainer();
    a.addFigure(new RectangleFigure({color: "#c6dbdc"}));
    a.addComponent(new Text({centered: true, text: "\xABsubsystem\xBB", margin: 1}));
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new ComponentSymbol({position: Component.TopRight, margin: 5}));
    a.addComponent(new TextBox({id: "name", centered: true, margin: 2}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
...
var UMLUseCaseClassifier = function (b) {
    ...
    a.addComponent(new StereotypeTagList({id: "stereotypes", centered: true}));
    a.addComponent(new TextArea({id: "name", centered: true, margin: 3}));
    a.addComponent(new ElipseSymbol({position: Component.TopRight, margin: 3}));
    a.setMenu([[function () {
        a.showStyleDialog({that: a});
        a.removeContextualMenu()
    }, "Style"], [function () {
