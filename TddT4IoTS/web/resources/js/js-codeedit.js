...
let valueLibraries, valueVariables, valueLoop, valueSetup, valueMethods, valueCodeGeneral;
...
valueMethods = "#----------------------------------------------\n" +
        ...
        "#╋╋┃┃╋┃┗┛┃┗┛┃┃┃┃╋╋┃┣┫┣┫┗┛┃╋┃┃╋┃┗┛┣━━┃\n" +
        "#╋╋┗┛╋┗━━┻━━┻┻┻┛╋╋┗┻━━┻━━┛╋┗┛╋┗━━┻━━┛\n";
valueCodeGeneral = "/* Code generated by Tddt4iots \n" +
...
var jsonCodeMirror = {'Libraries': valueLibraries, 'Variables': valueVariables, 'Loop': valueLoop,
    'Setup': valueSetup, 'Methods': valueMethods, 'CodeGeneral': valueCodeGeneral};

var libraries, variables, setup, loop, methods, codeGeneral;
loadEditCode = () => {
...
loadCodeGeneral = () => {
        codeGeneral = CodeMirror(document.getElementById("codeGeneral"),
            {
                lineNumbers: true,
                mode: "text/x-csrc",
                matchBrackets: true,
                value: jsonCodeMirror.CodeGeneral,
                readOnly: true,
                styleActiveLine: true,
                theme: 'eclipse',
                tabindex: 1,
